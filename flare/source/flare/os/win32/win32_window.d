module flare.os.win32.win32_window;
...
struct ImplCallbacks {
    WindowState* delegate(WindowId) nothrow get_state;
    void delegate(WindowId, CheckedVoidPtr) nothrow on_create;
    void delegate(WindowId) nothrow on_close;
    void delegate(WindowId) nothrow on_destroy;
    void delegate(WindowId, ushort, ushort) nothrow on_resize;
    void delegate(WindowId, KeyCode, ButtonState) nothrow on_key;
}
...
struct Win32WindowManager_old {
    ...
    void create_window(ref ImplCallbacks callbacks, WindowId id, ref WindowProperties properties, out DisplayImpl display) nothrow {
