...
module flare.memory.allocators.temp;

import flare.memory.allocators.allocator: Allocator;
import flare.memory.allocators.common : Ternary;
import flare.memory.measures: kib;
...
struct ScopedArena {
    import flare.memory.allocators.arena : Arena;
...
unittest {
    import flare.memory.allocators.allocator: AllocatorApi, test_allocate_api, test_reallocate_api, test_resize_api;
    import flare.memory.allocators.arena: Arena;
